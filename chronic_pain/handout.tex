...
\hypertarget{a-critical-safety-system}{%
\section{A critical safety system}\label{a-critical-safety-system}}

Life is fragile and under constant attack. Over millions of years,
Nature has developed a series of systems to increase its resilience,
\emph{pain} being one of the most critical. Although always unpleasant,
pain is what directs our attention to injuries, preventing long-term
\textbf{handicaps} and even death. Without it we would happily burn our
hands in boiling water, or walk around with a broken leg. Pain, then, is
a fundamental part of life.

\begin{marginfigure}
\includegraphics{figs/IASP_logo.png}
\end{marginfigure}

The International Association for the Study of Pain (IASP)\footnote{the
  \href{https://www.iasp-pain.org/Taxonomy}{IASP website} has a useful
  dictionary of terms related to pain} is the leading group tasked with
studying pain, and creating guidelines for its treatment. It defines
pains as:
...
We can break this down in two parts: first, pain is both a
\emph{sensory} and \emph{emotional} experience. This means it is
subjective, different from individual to individual, and dependent on
more than biology (the actual pain receptors). Emotions are not a mere
consequence of pain, but an important component of the whole system.
They are also a common source for misinterpretation and under- and
over-treatment\footnote{the so called sudlandersyndrom in Germany} ---
someone that typically exteriorizes her or his emotions, can have more
exuberant reactions to pain, in comparison to a more timid person. This
should not be outright discarded, but in fact function as a guide for
the physician to modulate treatment. A little extra assurance, a smile
and a touch on the shoulder can go a long way in calming down a patient,
and begin an effective pain therapy without a single prescription drug.
Positive emotions and the knowledge that one is being taken of are are
extremely effective in modulation pain \citep{Flaten2014}.

The second part of defines pain in terms of \emph{actual} or
\emph{perceived} damage. This is important because even in cases without
any (current) biological cause, the experience of pain is still quite
real. A physician should take all accounts of pain seriously, not just
when the patient clearly broke a foot or ate bad food. A good example of
this is fibromyalgia, which as of now has no known biological cause, but
can have a massive impact on a person's quality of life
\citep{Clauw2014}.

The IASP definition, while important for a standardized approach to
pain, does not take \emph{time} into account.

\begin{figure}
\centering
\includegraphics{figs/acute_chronic.png}
\caption{Acute and chronic pain.}
\end{figure}
...
\begin{marginfigure}
\includegraphics{handout_files/figure-latex/fig-margin-1} \caption[MPG vs horsepower, colored by transmission]{MPG vs horsepower, colored by transmission.}\label{fig:fig-margin}
\end{marginfigure}
...
\begin{figure*}
\includegraphics{handout_files/figure-latex/fig-fullwidth-1} \caption[A full width figure]{A full width figure.}\label{fig:fig-fullwidth}
\end{figure*}
...
\begin{figure}
\includegraphics{handout_files/figure-latex/fig-main-1} \caption[A figure in the main column]{A figure in the main column.}\label{fig:fig-main}
\end{figure}
...
\begin{figure}
\includegraphics{handout_files/figure-latex/fig-two-together-1} \includegraphics{handout_files/figure-latex/fig-two-together-2} \caption[Two plots in one figure environment]{Two plots in one figure environment.}\label{fig:fig-two-together}
\end{figure}
...
\begin{figure}
\includegraphics{handout_files/figure-latex/fig-two-separate-1} \caption[Two plots in separate figure environments (the first plot)]{Two plots in separate figure environments (the first plot).}\label{fig:fig-two-separate1}
\end{figure}
...
\begin{figure}
\includegraphics{handout_files/figure-latex/fig-two-separate-2} \caption[Two plots in separate figure environments (the second plot)]{Two plots in separate figure environments (the second plot).}\label{fig:fig-two-separate2}
\end{figure}
...
\begin{marginfigure}
\includegraphics{handout_files/figure-latex/fig-margin-together-1} \includegraphics{handout_files/figure-latex/fig-margin-together-2} \caption[Two plots in one figure environment in the margin]{Two plots in one figure environment in the margin.}\label{fig:fig-margin-together}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{handout_files/figure-latex/fig-margin-separate-1} \caption[Two plots in separate figure environments in the margin (the first plot)]{Two plots in separate figure environments in the margin (the first plot).}\label{fig:fig-margin-separate1}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{handout_files/figure-latex/fig-margin-separate-2} \caption[Two plots in separate figure environments in the margin (the second plot)]{Two plots in separate figure environments in the margin (the second plot).}\label{fig:fig-margin-separate2}
\end{marginfigure}
...
\begin{marginfigure}
\includegraphics{handout_files/figure-latex/fig-nocap-margin-1} \end{marginfigure}
...
\includegraphics{handout_files/figure-latex/fig-nocap-main-1}
...
\begin{figure*}
\includegraphics{handout_files/figure-latex/fig-nocap-fullwidth-1} \end{figure*}
