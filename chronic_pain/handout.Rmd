...
The current guidelines define *chronic* as "pain that persists or recurs for longer than 3 months".^[you can explore more at the [ICD-11 website](https://goo.gl/AX9GMr)] As of 2006, the prevalence of chronic pain in Europe was around 20% [@Breivik2006], with similarly high figures for the rest of world [@Elzahaf2012].

Even more importantly, data from the Global Burden of Disease Study 2016 [(GBD 2016)](http://www.healthdata.org/germany) shows low back and neck pain is the *number one cause* of disability in Germany.

![](figs/g_disab.png)


# Different origins, same unpleasantness
